...
function UpcomingTasks() {
  ...
  return (
    <div className="col-span-3 bg-colorB2 shadow-xl rounded-lg p-3">
      <p className="text-sm font-semibold mb-3">Upcoming Tasks</p>

      <div className="bg-colorB1 shadow-xl rounded-lg p-3">
              ...
              {tasks
                ...
                .map((task, index) => (
                  <li key={index}>
                    ...
                    <div className="grid grid-cols-12 gap-1 mt-2 items-center justify-between">
